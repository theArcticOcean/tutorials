var createModule = (() = >{
  ...
  return (function(createModule) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "vtkWasmUnwind.wasm";
    ...
    function setMainLoop(browserIterationFunc, fps, simulateInfiniteLoop, arg, noSetTiming) {
      ...
      console.log("simulateInfiniteLoop: ", simulateInfiniteLoop);
    ...
    function readEmAsmArgs(sigPtr, buf) {
      ...
      while (ch = HEAPU8[sigPtr++>>>0]) {
        ...
        buf += ch != 105 & buf;
        readEmAsmArgsArray.push(ch == 105 ? HEAP32[buf >>> 0] : HEAPF64[buf++>>>1]); ++buf
      }
