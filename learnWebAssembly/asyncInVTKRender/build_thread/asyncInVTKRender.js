...
[ "_worker_simu_complex_task_async", "_worker_cleanup", "__emscripten_thread_init", "__emscripten_thread_exit", "__emscripten_thread_crashed", "__emscripten_tls_init", "_pthread_self", "executeNotifiedProxyingQueue", "establishStackSpace", "invokeEntryPoint", "PThread", "___getTypeName", "__embind_initialize_bindings", "_fflush", "__emscripten_proxy_execute_task_queue", "___set_stack_limits", "onRuntimeInitialized" ].forEach(prop => {
...
wasmBinaryFile = "asyncInVTKRender.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  var pthreadMainJs = locateFile("asyncInVTKRender.worker.js");
...
var Asyncify = {
 instrumentWasmImports: function(imports) {
  var ASYNCIFY_IMPORTS = [ "env.worker_simu_complex_task_async", "env.worker_start_rendering", "env.invoke_*", "env.emscripten_sleep", "env.emscripten_wget", "env.emscripten_wget_data", "env.emscripten_idb_load", "env.emscripten_idb_store", "env.emscripten_idb_delete", "env.emscripten_idb_exists", "env.emscripten_idb_load_blob", "env.emscripten_idb_store_blob", "env.SDL_Delay", "env.emscripten_scan_registers", "env.emscripten_lazy_load_code", "env.emscripten_fiber_swap", "wasi_snapshot_preview1.fd_sync", "env.__wasi_fd_sync", "env._emval_await", "env._dlopen_js", "env.__asyncjs__*" ].map(x => x.split(".")[1]);
...
function readEmAsmArgs(sigPtr, buf) {
 ...
 while (ch = GROWABLE_HEAP_U8()[sigPtr++ >>> 0]) {
  ...
  buf += ch != 105 & buf;
  readEmAsmArgsArray.push(ch == 105 ? GROWABLE_HEAP_I32()[buf >>> 0] : GROWABLE_HEAP_F64()[buf++ >>> 1]);
  ++buf;
 }
...
var _worker_simu_complex_task_async = Module["_worker_simu_complex_task_async"] = createExportWrapper("worker_simu_complex_task_async");

var _worker_cleanup = Module["_worker_cleanup"] = createExportWrapper("worker_cleanup");
